    ...
    <template #default>
      <div>
          <form class="grid grid-cols-1 gap-6 m-16" @submit.prevent="submit">
              ...
              <button type="submit" class="bg-blue-500 hover:bg-blue-700 border border-solid rounded-md p-3 text-white font-bold">更新</button>
          </form>
      </div>
    </template>
  </app-layout>
        ...
        form: this.$inertia.form(
            {
              ...
              person_in_charge: this.task.person_in_charge
            },
            {
              bag: "taskUpdate",
